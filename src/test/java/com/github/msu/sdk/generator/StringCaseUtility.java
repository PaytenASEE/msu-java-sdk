...
public class StringCaseUtility {
    ...
    private final String [] allWords = {"merchant", "user", "date", "action", "password", "costumer",
            ...
            "items", "extra", "order", "bill", "address", "line", "city", "postal", "to", "country",
            ...
            "output", "this", "on", "state", "recurrence", "plan", "page", "interim", "tmx", "code"};
    ...
    public String toCamelCase(String input) {
        ...
        for (int i = 1; i <= input.length(); i++) {
            ...
            if (dictionary.contains(substring) && !dictionary.contains(input.substring(j, i+1))) {
                j = i;
    ...
    private String firstUpperCase(String s1) {
