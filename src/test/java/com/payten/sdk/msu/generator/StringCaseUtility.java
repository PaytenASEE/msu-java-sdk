...
public class StringCaseUtility {
    ...
    private final String[] allWords = {"merchant", "user", "date", "day", "commission", "reflect", "action", "password", "customer", "custom", "session", "type", "return", "url", "payment", "id",
            ...
            "installments", "installment", "bank", "commission", "included", "original", "points", "campaigns", "initiate", "business", "cvv", "threat", "metrix", "dealer", "sub", "status",
            "limit", "offset", "start", "end", "pan", "result", "hpp", "setting", "apply", "rate", "dto", "from", "bin", "api", "gate", "default", "group", "notification",
            "channels", "recurring", "count", "discount", "credit", "associated", "systems", "pay", "by", "link", "displayed", "content", "split", "codes", "fax", "reason", "locked", "role", "confirm",
            ...
            "interim", "tmx", "code", "to", "cutoff", "address", "web", "void", "preauth", "postauth", "savable", "auth", "read", "remove", "system", "old", "new", "issue", "check", "company",
            ...
            "text", "compay", "response", "request", "adjust", "rates", "eft", "bkm", "policy", "gate", "3d", "key", "executive", "report", "interest", "valid", "for", "debit",
            "e", "wallet", "resend"};
