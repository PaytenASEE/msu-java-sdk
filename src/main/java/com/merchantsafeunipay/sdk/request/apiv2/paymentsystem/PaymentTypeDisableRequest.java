...
public class PaymentTypeDisableRequest extends ApiRequest<PaymentTypeDisableResponse> {
    ...
    @Override
    public Class<PaymentTypeDisableResponse> responseClass() {
        return PaymentTypeDisableResponse.class;
    }
