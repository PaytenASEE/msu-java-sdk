...
public class DealerTypeDeleteRequest extends ApiRequest<DealerTypeDeleteResponse> {
    ...
    @Override
    public Class<DealerTypeDeleteResponse> responseClass() {
        return DealerTypeDeleteResponse.class;
    }
