...
public class QueryDealerTypeRequest extends ApiRequest<QueryDealerTypeResponse> {
    ...
    @Override
    public Class<QueryDealerTypeResponse> responseClass() {
        return QueryDealerTypeResponse.class;
    }
