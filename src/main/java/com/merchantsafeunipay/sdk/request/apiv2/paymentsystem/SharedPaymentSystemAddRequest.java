...
public class SharedPaymentSystemAddRequest extends ApiRequest<SharedPaymentSystemAddResponse> {
    ...
    @Override
    public Class<SharedPaymentSystemAddResponse> responseClass() {
        return SharedPaymentSystemAddResponse.class;
    }
