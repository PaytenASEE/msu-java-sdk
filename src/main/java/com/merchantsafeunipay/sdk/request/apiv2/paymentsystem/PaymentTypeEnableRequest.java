...
public class PaymentTypeEnableRequest extends ApiRequest<PaymentTypeEnableResponse> {
    ...
    @Override
    public Class<PaymentTypeEnableResponse> responseClass() {
        return PaymentTypeEnableResponse.class;
    }
