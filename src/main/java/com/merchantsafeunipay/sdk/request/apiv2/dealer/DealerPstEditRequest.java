...
public class DealerPstEditRequest extends ApiRequest<DealerPstEditResponse> {
    ...
    @Override
    public Class<DealerPstEditResponse> responseClass() {
        return DealerPstEditResponse.class;
    }
