...
public class ReconciliationSchemaAddRequest extends ApiRequest<ReconciliationSchemaAddResponse> {
    ...
    @Override
    public Class<ReconciliationSchemaAddResponse> responseClass() {
        return ReconciliationSchemaAddResponse.class;
    }
