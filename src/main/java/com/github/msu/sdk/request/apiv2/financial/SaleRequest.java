...
@ResponseInfo(
        responseClass = com.github.msu.sdk.response.SaleResponse.class
)
public class SaleRequest extends ApiRequest {
    ...
    public void applyRequestParams() {
        ...
        addToPayload(com.github.msu.sdk.request.enumerated.Param.POINTS, this.points);
        addToPayload(com.github.msu.sdk.request.enumerated.Param.CAMPAIGNS, this.campaigns);
